    ...
    rows = [
        {
            ...
            "silver_claims": [{"normalized_claim_text": "Government should ban coal projects."}],
        },
        {
            "chunk_id": "chunk_2",
            "chunk_text": "Policy should reduce emissions by 4.9%.",
            "silver_claims": [{"normalized_claim_text": "Policy should reduce emissions by 4.9%."}],
        },
        {
            "chunk_id": "chunk_3",
        ...
        },
        {
            ...
            "silver_claims": [
                {"normalized_claim_text": "Government should ban coal projects."},
            ],
        },
        {
            "chunk_id": "chunk_5",
            "chunk_text": "The baseline should fail this gate example.",
            "silver_claims": [{"normalized_claim_text": "This claim is not memorized."}],
        },
        {
            "chunk_id": "chunk_6",
            "chunk_text": "Another row without known training claim.",
            "silver_claims": [{"normalized_claim_text": "Another missing claim."}],
        },
        {
            "chunk_id": "chunk_7",
...
def test_run_writes_model_artifact_and_summary(tmp_path: Path) -> None:
    ...
    model_output_path = tmp_path / "claims_model.json"
    ...
    artifact = json.loads(model_output_path.read_text(encoding="utf-8"))
    assert artifact["model_version"] == "claims-baseline-v1"
    assert isinstance(artifact["memorized_claims"], list)
