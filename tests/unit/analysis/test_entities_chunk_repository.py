"""Unit tests for entities filesystem chunk repository adapter behavior."""
...
from ddd_policy_tracer.analysis.entities import FilesystemChunkRepository
...
def _write_chunk_record(*, path: Path, chunk_id: str) -> None:
    ...
    record = {
        ...
        "start_char": 0,
        "end_char": 42,
        "chunk_text": "The Clean Energy Act applies in Queensland.",
    }
